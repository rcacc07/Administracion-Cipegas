package com.cipegas.administracion.components
...
import com.cipegas.administracion.util.Constants.Companion.CUSTOM_BLACK
import com.cipegas.administracion.util.Constants.Companion.CUSTOM_GREEN
...
@Composable
fun CardBank(banks: List<BankItem> , onClick: () -> Unit) {
    Card(
